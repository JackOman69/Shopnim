...
<link media="all" type="text/css" href="http://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet">
<link media="all" type="text/css" href="http://fonts.googleapis.com/css?family=Lilita+One:400" rel="stylesheet">
...
<link href="catalog/view/theme/OPC064/stylesheet/stylesheet.css" rel="stylesheet" type="text/css" />
...
<link href="catalog/view/theme/OPC064/stylesheet/TemplateTrip/rtl.css" rel="stylesheet" type="text/css" />
<link href="catalog/view/theme/OPC064/stylesheet/TemplateTrip/ttblogstyle-rtl.css" rel="stylesheet" type="text/css" />
<?php } ?>
...
<nav id="top">
  ...
  <?php if($header_left) { ?>
	  ...
	  <?php } ?>
		...
		<?php echo $language; ?>
		<?php if($header_top) { ?>
				<div class="header-top-cms col-sm-4">
				<?php echo $header_top; ?>
				</div>
		<?php } ?>
	</div>
  ...
  <?php } ?>
	  ...
	  <div class="header-right col-sm-3">
		...
		<li class="ttsearch"><?php echo $search;?></li>
	  	<li class="dropdown header_user_info"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="ttuserheading"><?php echo $text_account; ?></span> <i class="fa fa-caret-down ttuserinfo"></i></a>
